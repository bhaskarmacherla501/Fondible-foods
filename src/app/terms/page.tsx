  ...
  return (
    <div className="page-container py-16 max-w-3xl mx-auto">
      ...
      <div className="space-y-8 text-brown/80 leading-relaxed">
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">1. About Us</h2>
          <p>Fondible Foods is a proprietorship business operated by A Hemavati, registered in Hyderabad, Telangana, India (GSTIN: 36BICPH8750D1ZE). References to &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;Fondible&rdquo; throughout these terms refer to this business.</p>
        </section>

        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">2. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">3. Orders & Pricing</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">4. Payments</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">5. Product Information</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">6. Intellectual Property</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">7. Limitation of Liability</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">8. Governing Law</h2>
