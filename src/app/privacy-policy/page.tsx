    ...
    <div className="page-container py-16 max-w-3xl mx-auto">
      ...
      <div className="space-y-8 text-brown/80 leading-relaxed">
        <section>
          ...
          <p>Fondible Foods is a proprietorship business operated by A Hemavati, registered in Hyderabad, Telangana, India (GSTIN: 36BICPH8750D1ZE). This policy explains how we collect, use, and protect your personal information when you use our website.</p>
        </section>

        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">2. Information We Collect</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">3. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">4. Sharing With Third Parties</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">5. Cookies</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">6. Data Security</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">7. Your Rights</h2>
        ...
        <section>
          <h2 className="font-display text-xl font-semibold text-brown mb-3">8. Contact Us</h2>
