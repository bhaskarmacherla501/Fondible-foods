...
async function main() {
  ...
  const products = [
    ...
    {
      name: 'Pumpkin Seed Cookies', slug: 'pumpkin-seed-cookies',
      shortDesc: 'Crunchy roasted pumpkin seeds pressed into a buttery whole wheat base — zinc-rich, jaggery sweetened.',
      isFeatured: true, isBestseller: false, isNew: true,
      price: 289, pack: '230g Pack', stock: 30, sku: 'FND-PSC-230',
      ingredients: 'Stone-ground whole wheat flour, fresh churned butter, roasted pumpkin seeds, jaggery, cold-pressed oil, rock salt',
      healthBenefits: ['Zinc & Magnesium Rich', 'Real Butter', 'Immune Supporting', 'No Refined Sugar', 'Whole Ingredients Only'],
      tags: ['seeds', 'pumpkin-seed', 'new'],
    },
    {
